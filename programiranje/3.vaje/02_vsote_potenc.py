...
# =============================================================================
def vsota_prvih(n):
    vsota = 0  # Tukaj bomo zbirali rezultat
    # range(1, n + 1) gre od 1 do vključno n
    for i in range(1, n + 1):
        vsota += i  # Vsakič prištejemo trenutno število
    return vsota
# =====================================================================@000979=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzgsInVzZXIiOjExNDY2fQ:1w2TiG:1RUkPChfF28Mm8w68Qme0Wvh_lJNtBPyAfNRxFjnbSU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzksInVzZXIiOjExNDY2fQ:1w2TiG:FQsoJarOVFGOSTZU-EcliPOp-FDXjcZb8IocHgMkZy0"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODAsInVzZXIiOjExNDY2fQ:1w2TiG:z0pA-uzFl7J3SJ9JHNJXIN5B8FZ5K8kFaaq2vCARnJw"
        try:
            try:
