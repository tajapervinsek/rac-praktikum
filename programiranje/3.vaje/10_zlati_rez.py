...
# =============================================================================
def priblizek(k):
    p = 1  # Začetni približek phi_0
    for _ in range(k):
        p = naslednji_priblizek(p)
    return p
# =====================================================================@001002=
# 3. podnaloga
...
def natancni_priblizek(eps):
    prejsnji = 1
    trenutni = naslednji_priblizek(prejsnji)
    
    # Dokler je razlika med njima večja ali enaka eps, računamo naprej
    while abs(trenutni - prejsnji) >= eps:
        prejsnji = trenutni
        trenutni = naslednji_priblizek(prejsnji)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAwLCJ1c2VyIjoxMTQ2Nn0:1w2WKh:XfJ7kiI0DAlm4BeEUNREml6G7eus1ktEyJXQTNr1j_Y"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAxLCJ1c2VyIjoxMTQ2Nn0:1w2WKh:2lSrSXsAF6NoPNGeAOQQjnw9VIcR3BWh4LXU3bJPVS4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAyLCJ1c2VyIjoxMTQ2Nn0:1w2WKh:29MFQ31iQlckyQ10ZNk0IvgNFFldQafAgBCHSi3eTaI"
        try:
