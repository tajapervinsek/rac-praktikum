...
# =============================================================================
def pravilni_del_gesla(niz, crke):
    rezultat = ""
    # Sprehodimo se čez geslo (niz)
    for znak in niz:
        # Preverimo, če je trenutni znak med uganjenimi črkami
        if znak in crke:
            rezultat += znak
        else:
            rezultat += "_"
...
#     'j?'
# =============================================================================
def nepravilni_ugibi(niz, crke):
    rezultat = ""
    # Sprehodimo se čez vse črke, ki smo jih ugibali
    for znak in crke:
        # Če ugibane črke NI v geslu (niz), je to napačen ugib
        if znak not in niz:
            rezultat += znak  # Uporabi += namesto -=
    return rezultat
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NSwidXNlciI6MTE0NjZ9:1w2UCO:4Bf_94eg71JdhvH1eQdNQS4491xeGCTG2GqUI9SBghU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NiwidXNlciI6MTE0NjZ9:1w2UCO:Kk-0_qjduMAuBTXc-wTn7MuJWmBEGF8G3-TYD5JewFs"
        try:
