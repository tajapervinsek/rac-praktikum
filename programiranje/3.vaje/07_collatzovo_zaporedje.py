...
def najdaljse_zaporedje(m, n):
    # Za začetek nastavimo na 0 ali na dolžino prvega števila
    najdaljse = 0 
    
    for i in range(m, n + 1):
        trenutna_dolzina = dolzina_zaporedja(i)
        # Če je trenutna dolžina večja od do sedaj največje, jo posodobimo
        if trenutna_dolzina > najdaljse:
            najdaljse = trenutna_dolzina
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODUsInVzZXIiOjExNDY2fQ:1w2UoY:W4lToLInZ2aQwhZZ5Bwvr26cq7C2RjyJBdXKZlVCiCc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODYsInVzZXIiOjExNDY2fQ:1w2UoY:N7m8Zchh2gggJhbOCXPNvuYZWrvVgHT-n3tC0gJemMg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODcsInVzZXIiOjExNDY2fQ:1w2UoY:epSmyO1XOpuAz6OjqsS_NFtjyqUVlI7Y6wwDZFcYS7A"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODgsInVzZXIiOjExNDY2fQ:1w2UoY:igpMUZcqPWxPHI6qsskP5OB81R0E0mKCyVMgDVJ9ydI"
        try:
