...
%     \centering
%     \label{table:mag3}
%     \caption{Magični kvadrat reda 3}\hline
%     \begin{tabular}{|c|c|c│}
%         3 & 5 & 7 \\\hline
%         4 & 9 & 2 \\\hline
%         8 & 1 & 6 \\\hline
...
\begin{definicija}
   Magični kvadrat reda $n$ je \emph{\color{purple}normalen}, če v njem nastopajo števila
   \begin{equation}
      \label{eq:numbers}
...
\emph{\color{purple}Lo Shu} -- ">zvitek reke Lo"<. V antični Kitajski je prišlo do
...
\emph{\color{purple}Kubera-Kolam} je talna poslikava, ki se uporablja v Indiji, in je v
...
Magični kvadrat v litografiji Melancholia I (glej sliko \ref{eq:mc}
...
\begin{definicija}
      ...
      v magičnem kvadratu imenujemo \emph{\color{purple}magična konstanta}.
\end{definicija}
...
\begin{definicija}
      ...
      \emph{\color{purple}komplementaren}.
\end{definicija}
...
\begin{definicija}
      Pravimo, da sta dva magična kvadrata \emph{\color{purple}različna}, če enega ni mogoče dobiti
